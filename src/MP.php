...
class MP {
    ...
    /**
     * Retorna merchant_orders (creado por Woopi)
     * @param int $id
     * @return array(json)
     */
    public function get_merchant_order($order_id)
    {
        ...
        $request = array(
            "uri" => $uri_prefix . "/merchant_orders/" . $order_id,
            "params" => array(
...
class MPRestClient {
    ...
    private static function build_request($request) {
        ...
        //Metemos el integrator ID de woopi
        array_push ($headers, "x-integrator-id: dev_b70bef44914611eaae570242ac130004");
